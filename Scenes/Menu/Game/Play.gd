...
func _input(event):
	...
	if(event.is_action_pressed("left2")):
		...
		if($PanelContainer/P2Sprite.get_animation() == "Blue Idle"):
			$PanelContainer/P2Sprite.set_animation("Green Idle")
		elif($PanelContainer/P2Sprite.get_animation() == "Red Idle"):
			$PanelContainer/P2Sprite.set_animation("Yellow Idle")
		elif($PanelContainer/P2Sprite.get_animation() == "Yellow Idle"):
			$PanelContainer/P2Sprite.set_animation("Blue Idle")
		elif($PanelContainer/P2Sprite.get_animation() == "Green Idle"):
			$PanelContainer/P2Sprite.set_animation("Red Idle")
